exports.up = function(knex) {
  return knex.schema.raw(`
    ...
    ALTER TABLE bad_person_to_person ADD FOREIGN KEY (person_id) REFERENCES persons (id);
    ALTER TABLE bad_person_to_person ADD FOREIGN KEY (bad_person_id) REFERENCES bad_persons (id);
    ALTER TABLE bad_person_to_person ADD primary key(bad_person_id,person_id);

    CREATE TABLE bad_company_to_company(
      bad_company_id UUID NOT NULL,
      company_id UUID NOT NULL
    );
    ALTER TABLE bad_company_to_company ADD FOREIGN KEY (company_id) REFERENCES companies (id);
    ALTER TABLE bad_company_to_company ADD FOREIGN KEY (bad_company_id) REFERENCES bad_companies (id);
    ALTER TABLE bad_company_to_company ADD primary key(bad_company_id,company_id);
